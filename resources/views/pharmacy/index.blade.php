...
@section("header","Farmacias")

@section("breadcrumb")


    <li class="breadcrumb-item"><a href="{{route("index")}}">Inicio</a></li>
    <li class="breadcrumb-item">farmacias</li>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="exampleModalLabel">eliminar farmacia</h1>
                ...
                <div class="modal-body">
                    <div>
                        <div class="d-flex align-items-center">
                            ...
                            Eliminar esta farmacia eliminará todos los doctores y pedidos asignados a ella.<br>
