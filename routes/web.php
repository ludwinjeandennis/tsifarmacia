...
Route::group(["middleware" => ["auth", "role:admin|pharmacy|doctor", "logs-out-banned-user", "verified"]], function () {
    ...
    Route::get('/dashboard/managerial', [DashboardController::class, 'index'])->name('dashboard.managerial');
    ...
    /*================================== start predictions route ================================== */
     Route::get('/predictions', [\App\Http\Controllers\PredictionController::class , 'index'])->name('predictions.index');
     Route::get('/model-metrics', [\App\Http\Controllers\ModelMetricsController::class , 'index'])->name('model.metrics');
    /*================================== end predictions route ================================== */
});
